...
window_sizes = [int(float(2000)/milliseconds_per_instance), int(float(4000)/milliseconds_per_instance), int(float(10000)/milliseconds_per_instance)]
...
selected_predictor_cols = ['acc_Acceleration x (m/s^2)', 'acc_Acceleration y (m/s^2)', 'acc_Acceleration z (m/s^2)',
  'press_Pressure (hPa)', 'gyr_Gyroscope x (rad/s)', 'gyr_Gyroscope y (rad/s)', 'gyr_Gyroscope z (rad/s)',
...
dataset.to_csv(dataset_path + 'chapter4_time.csv')
