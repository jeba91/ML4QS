...
try:
    dataset = pd.read_csv(dataset_path + 'chapter5_final.csv', index_col=0)
except IOError as e:
...
basic_features = ['acc_Acceleration x (m/s^2)', 'acc_Acceleration y (m/s^2)', 'acc_Acceleration z (m/s^2)', 'press_Pressure (hPa)',
                 'gyr_Gyroscope x (rad/s)', 'gyr_Gyroscope y (rad/s)', 'gyr_Gyroscope z (rad/s)', 'hr_Heart Rate',
                 'mag_Magnetic field x (muT)', 'mag_Magnetic field y (muT)', 'mag_Magnetic field z (muT)',
                 'linacc_Linear Acceleration x (m/s^2)', 'linacc_Linear Acceleration y (m/s^2)', 'linacc_Linear Acceleration z (m/s^2)']
...
cluster_features = ['cluster_acc_Acceleration', 'cluster_gyr_Gyroscope', 'cluster_linacc_Linear Acceleration', 'cluster_mag_Magnetic field']
...
selected_features = ['gyr_Gyroscope y (rad/s)_pse', 'acc_Acceleration y (m/s^2)_freq_0.9_Hz_ws_20', 'acc_Acceleration z (m/s^2)_max_freq',
'hr_Heart Rate_max_freq', 'mag_Magnetic field x (muT)_temp_std_ws_8', 'press_Pressure (hPa)_temp_mean_ws_8',
'linacc_Linear Acceleration y (m/s^2)_freq_0.0_Hz_ws_20', 'mag_Magnetic field x (muT)_freq_0.0_Hz_ws_20',
'mag_Magnetic field y (muT)_temp_std_ws_8', 'linacc_Linear Acceleration x (m/s^2)_pse']
